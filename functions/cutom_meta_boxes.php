...
function saveMetaData($post_id, $post) {
	...
	// if our nonce isn't there, or we can't verify it, bail
	if( !isset( $_POST['awd_nonce_field'] ) || !wp_verify_nonce( $_POST['awd_nonce_field'], 'awd_nonce_action' ) ) return;
...
function mytheme_save_data($post_id) {
	...
	// if our nonce isn't there, or we can't verify it, bail
	if( !isset( $_POST['mytheme_nonce_field'] ) || !wp_verify_nonce( $_POST['mytheme_nonce_field'], 'mytheme_nonce_action' ) ) return;
